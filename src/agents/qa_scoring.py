...
Provide fair, baseline-anchored scores across all five dimensions. Be specific with your feedback and cite timestamps."""
    ...
    for attempt in range(max_retries):
        try:
            ...
            logger.info(f"scoring_result: {scoring_result.professionalism}")

            # Compute overall_score using dimension weights, overriding LLM's value
            computed_overall = (
            ...
            # Replace the LLM's overall_score with computed value
